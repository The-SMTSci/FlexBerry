...
\end{tcolorbox}
\caption{#1}
\label{fig:Snippet#2} % fig:<filename>
\end{figure}
}
%  https://tex.stackexchange.com/questions/223363/breaking-problem-in-tcolorbox-break-at-breakable 
...
\include{PuTTYXming.tex}
\include{IRAFPyRAF.tex}
